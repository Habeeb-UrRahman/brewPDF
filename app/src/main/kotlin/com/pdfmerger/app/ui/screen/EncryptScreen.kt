...
import com.pdfmerger.app.ui.theme.ToolEncrypt
...
@Composable
fun EncryptScreen(initialUri: Uri? = null, onBack: () -> Unit) {
...
val filePicker = rememberLauncherForActivityResult(
    ...
    BrewScaffold(
        title = "Lock PDF",
        subtitle = "Protect your document with a password",
        onBack = onBack,
        bottomBar = {
            if (selectedUri != null) {
                ToolBottomBar(
                        ...
                        scope.launch {
                            try {
                                withContext(Dispatchers.IO) {
                                    val inputFile = FileProviderUtil.copyUriToStaging(context, selectedUri!!, "preview_encrypt_input_${System.currentTimeMillis()}.pdf")
                                        ?: throw Exception("Failed to read file")
                                    val outputFile = File(context.cacheDir, "preview_locked_${System.currentTimeMillis()}.pdf")
                    ...
                    isActionEnabled = password.isNotEmpty() && password == confirmPassword && !isProcessing && !isDone,
        ...
        if (selectedUri == null) {
            ...
            BrewPickerPrompt(
                ...
                title = "Select a PDF",
                subtitle = "Choose a file to lock",
                accentColor = ToolEncrypt,
            ...
            OutlinedTextField(
                ...
                colors = OutlinedTextFieldDefaults.colors(
                    focusedBorderColor = ToolEncrypt,
                    focusedLabelColor = ToolEncrypt
                )
            )
